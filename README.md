# Mon Profil 
![Photo](https://th.bing.com/th/id/R.e22f9acfeb209fe0e8820d944c7eac32?rik=JiMa%2b3Xq3VYBFw&pid=ImgRaw&r=0)
...
```mermaid
graph TD;
    A[Début] --> B[Installer VS Code];
    B --> C[Installer les extensions Markdown];
    C --> D[Créer un fichier .md];
    D --> E[Rédiger le contenu];
    E --> F{Rendu correct ?};
    F -- Oui --> G[Convertir avec Pandoc];
    F -- Non --> E;
    G --> H[HTML];
    G --> I[PDF];
    G --> J[DOCX];
